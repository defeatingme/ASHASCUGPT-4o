...
#from ak_camera_ui import Ui_AK_Camera
#from camera_ui2 import Ui_Camera
...
class AK_Camera(QMainWindow):
    ...
    def initialize(self):
        ...
        #self._ui.captureFrame.currentChanged.connect(self.updateCaptureMode)
    ...
    def updateCaptureMode(self):
        pass
        #tab_index = self._ui.captureFrame.currentIndex()
