...
class Ui_Camera(object):
    def setupUi(self, Camera):
        ...
        self.stackedWidget.setGeometry(QRect(0, 0, 820, 710))
...
"")
        ...
        self.frame_has_data.setGeometry(QRect(830, 140, 191, 201))
        font = QFont()
        font.setFamilies([u"Segoe UI"])
        font.setPointSize(11)
        font.setItalic(True)
        self.frame_has_data.setFont(font)
...
"border-radius: 2px")
        ...
        self.label_total_time.setGeometry(QRect(0, 80, 191, 61))
        font1 = QFont()
...
"background-color: None")
        ...
        self.label_ocr_time.setGeometry(QRect(0, 0, 191, 41))
...
"background-color: None")
        ...
        self.label_check_time.setGeometry(QRect(0, 40, 191, 41))
...
"background-color: None")
        ...
        self.label_prob_count = QLabel(self.frame_has_data)
        self.label_prob_count.setObjectName(u"label_prob_count")
        self.label_prob_count.setGeometry(QRect(0, 140, 191, 61))
        self.label_prob_count.setFont(font1)
        self.label_prob_count.setStyleSheet(u"color: rgb(224, 224, 224);\n"
"background-color: None")
        self.label_prob_count.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignTop)
        self.frame_prev_data = QFrame(self.centralwidget)
        self.frame_prev_data.setObjectName(u"frame_prev_data")
        self.frame_prev_data.setGeometry(QRect(830, 10, 191, 121))
        self.frame_prev_data.setFont(font)
        self.frame_prev_data.setStyleSheet(u"background-color: qlineargradient(spread:pad, x1:1, y1:1, x2:1, y2:0, stop:0 rgba(40, 40, 40, 255), stop:1 rgba(56, 56, 56, 255));\n"
"border: 1px solid rgb(175, 192, 220);\n"
"border-radius: 2px")
        self.frame_prev_data.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_prev_data.setFrameShadow(QFrame.Shadow.Raised)
        self.label_last_name = QLabel(self.frame_prev_data)
        self.label_last_name.setObjectName(u"label_last_name")
        self.label_last_name.setGeometry(QRect(0, 80, 191, 41))
...
"background-color: None")
        ...
        self.label_counter = QLabel(self.frame_prev_data)
        self.label_counter.setObjectName(u"label_counter")
        self.label_counter.setGeometry(QRect(0, 40, 191, 41))
...
"background-color: None")
        ...
        self.label_ak_count = QLabel(self.frame_prev_data)
        self.label_ak_count.setObjectName(u"label_ak_count")
        self.label_ak_count.setGeometry(QRect(0, 0, 191, 41))
        self.label_ak_count.setFont(font1)
...
"background-color: None")
        ...
        self.label_student_name.setGeometry(QRect(510, 725, 80, 21))
        font2 = QFont()
...
"")
        ...
        self.push_view_has.setGeometry(QRect(290, 720, 151, 25))
        font3 = QFont()
...
"    }")
        ...
        self.push_view_ak.setGeometry(QRect(160, 720, 121, 25))
        self.push_view_ak.setFont(font3)
...
"    }")
        ...
        self.edit_student_name.setGeometry(QRect(580, 720, 240, 30))
        self.edit_student_name.setFont(font3)
...
"color: rgb(224, 224, 224)")
        ...
        self.label_note_autofill.setGeometry(QRect(825, 725, 181, 20))
        font4 = QFont()
...
"color: rgb(224, 224, 224)")
        ...
        self.frame.setGeometry(QRect(830, 350, 191, 361))
        font5 = QFont()
...
"border-radius: 2px")
        ...
        self.push_recheck.setGeometry(QRect(10, 210, 171, 41))
...
"    }")
        ...
        self.push_redo.setGeometry(QRect(10, 260, 171, 41))
...
"    }")
        ...
        self.push_size.setGeometry(QRect(10, 320, 171, 25))
        font6 = QFont()
        font6.setFamilies([u"Segoe UI"])
        font6.setPointSize(11)
        font6.setBold(False)
        self.push_size.setFont(font6)
...
"    }")
        ...
        self.label.setGeometry(QRect(0, 50, 191, 20))
        font7 = QFont()
...
"color: #eee")
        ...
        self.takeImageButton.setGeometry(QRect(10, 150, 171, 41))
        self.takeImageButton.setFont(font7)
...
"    }")
        ...
        self.exposureCompensation.setGeometry(QRect(10, 70, 171, 41))
...
"border: None;")
        ...
        self.label_image.setGeometry(QRect(0, 0, 191, 31))
        self.label_image.setFont(font2)
        self.label_image.setStyleSheet(u"background-color: rgb(48, 48, 48);\n"
"color: rgb(224, 224, 224);\n"
"")
        self.label_image.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignVCenter)
        self.frame_result = QFrame(self.centralwidget)
        self.frame_result.setObjectName(u"frame_result")
        self.frame_result.setGeometry(QRect(1030, 350, 401, 360))
        font8 = QFont()
        self.frame_result.setFont(font8)
...
"")
        ...
        self.label_sol_grade.setGeometry(QRect(0, 310, 121, 50))
        self.label_sol_grade.setFont(font6)
...
"")
        ...
        self.label_fa_grade.setGeometry(QRect(120, 310, 120, 50))
        self.label_fa_grade.setFont(font6)
...
"")
        ...
        self.label_overall_grade.setGeometry(QRect(240, 310, 161, 50))
        self.label_overall_grade.setFont(font6)
...
"")
        ...
        self.web_result.setGeometry(QRect(0, 30, 401, 280))
        self.web_result.setFont(font5)
...
"")
        ...
        self.frame_latex.setGeometry(QRect(1030, 10, 401, 331))
        self.frame_latex.setFont(font8)
...
"border-radius: 2px")
        ...
        self.web_latex.setGeometry(QRect(0, 30, 401, 300))
        self.web_latex.setFont(font5)
...
"")
        ...
        self.label_latex.setGeometry(QRect(0, 0, 401, 30))
...
"")
        ...
        self.push_save.setGeometry(QRect(1050, 720, 361, 25))
        font9 = QFont()
        font9.setFamilies([u"Segoe UI"])
        font9.setPointSize(11)
        font9.setBold(False)
        font9.setItalic(False)
        self.push_save.setFont(font9)
...
"background-color: rgb(64,64,64)")
    ...
    def retranslateUi(self, Camera):
        ...
        self.label_total_time.setText(QCoreApplication.translate("Camera", u"Total runtime from capture\n"
"to result display:\n"
" 0.00s", None))
...
" 0.00s", None))
        self.label_prob_count.setText(QCoreApplication.translate("Camera", u"No. of problems aimed to\n"
"solve by the solution:\n"
" 0 ", None))
        self.label_last_name.setText(QCoreApplication.translate("Camera", u"Last checked from:\n"
" None", None))
        self.label_counter.setText(QCoreApplication.translate("Camera", u"No. of solutions recorded:\n"
" 0", None))
        self.label_ak_count.setText(QCoreApplication.translate("Camera", u"No. of AKs: 1\n"
"FA weight: 20", None))
...
"checking", None))
        ...
        self.label_image.setText(QCoreApplication.translate("Camera", u"Image: ", None))
